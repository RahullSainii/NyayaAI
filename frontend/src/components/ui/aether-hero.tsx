...
export default function AetherHero({
  ...
  align = 'center',
  maxWidth = 1200,
  overlayGradient = 'linear-gradient(180deg, rgba(6,9,16,0.8), rgba(6,9,16,0.4) 40%, transparent)',
  textColor = '#f0f2f8',
  ...
  return (
    ...
    >
      ...
      {/* Overlay gradient for readability (darkened for NyayaAI cinematic theme) */}
      <div
                  ...
                  {ctaLabel && (
                    <a
                      ...
                      style={{
                        ...
                        borderRadius: 12,
                        background:
                          'linear-gradient(180deg, rgba(212,166,78,.18), rgba(212,166,78,.06))',
                        color: textColor,
                        textDecoration: 'none',
                        fontWeight: 600,
                        boxShadow:
                          'inset 0 0 0 1px rgba(212,166,78,.28), 0 10px 30px rgba(0,0,0,.2)',
